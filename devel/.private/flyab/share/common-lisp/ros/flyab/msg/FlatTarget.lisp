...
(cl:defmethod cl:initialize-instance :after ((m <FlatTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlatTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flyab-msg:<FlatTarget> is deprecated: use flyab-msg:FlatTarget instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:header-val is deprecated.  Use flyab-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'type_mask-val :lambda-list '(m))
(cl:defmethod type_mask-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:type_mask-val is deprecated.  Use flyab-msg:type_mask instead.")
  (type_mask m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:position-val is deprecated.  Use flyab-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:velocity-val is deprecated.  Use flyab-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:acceleration-val is deprecated.  Use flyab-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'jerk-val :lambda-list '(m))
(cl:defmethod jerk-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:jerk-val is deprecated.  Use flyab-msg:jerk instead.")
  (jerk m))

(cl:ensure-generic-function 'snap-val :lambda-list '(m))
(cl:defmethod snap-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyab-msg:snap-val is deprecated.  Use flyab-msg:snap instead.")
  (snap m))
